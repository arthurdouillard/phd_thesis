\begin{table*}
    ...
    \begin{tabular}{@{}lccccc@{}}
        ...
        \bottomrule
    \end{tabular}
    \caption{\textbf{Ablation study: } Comparison of the average incremental accuracy on CIFAR100 with 50 steps of the model when disabling parts of the complete \ac{PODNet} loss\\~}
