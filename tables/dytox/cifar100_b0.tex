\begin{table*}[t]
    ...
    \resizebox{1.0\textwidth}{!}{%
        \begin{tabular}{@{}l|ccc|ccc|ccc}
            ...
            \hline
            iCaRL \scriptsize{\citep{rebuffi2017icarl}}       & 11.22                        & 65.27\scriptsize{\mypm1.02}                   & 50.74                        & 11.22               & 61.20\scriptsize{\mypm0.83}                   & 43.75                            & 11.22               & 56.08\scriptsize{\mypm0.83}                   & 36.62                            \\
            UCIR \scriptsize{\citep{hou2019ucir}}             & 11.22                        & 58.66\scriptsize{\mypm0.71}                   & 43.39                        & 11.22               & 58.17\scriptsize{\mypm0.30}                   & 40.63                            & 11.22               & 56.86\scriptsize{\mypm0.83}                   & 37.09                            \\
            ...
            DER \small{w/o P} \scriptsize{\citep{yan2021der}} & 112.27                       & 75.36\scriptsize{\mypm0.36}                   & \textbf{65.22}               & 224.55              & 74.09\scriptsize{\mypm0.33}                   & 62.48                            & 561.39              & 72.41\scriptsize{\mypm0.36}                   & 59.08                            \\ % no pruning
    ...
    \caption{\textbf{Results on CIFAR100} averaged over three different class orders. Baselines
        results are come from \citet{yan2021der}. The $\dagger$ symbol means that \citet{yan2021der}
        needed setting-sensitive hyperparameters. Moreover, its reported parameters count was an average
        over all steps: the final parameters count (necessarily higher) was not available. DyTox+ uses
        MixUp \citep{hingyi2018mixup} and DyTox++ uses both MixUp and SAM \citep{kwon2021asam}.}
