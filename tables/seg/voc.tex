\begin{table*}[t]
    ...
    \begin{adjustbox}{max width=\textwidth}
        ...
        \end{tabular}
    \end{adjustbox}
    \caption{Continual Semantic Segmentation results on Pascal-VOC 2012 in \ac{mIoU} (\%). $\dagger$: results excerpted from ~\cite{cermelli2020modelingthebackground}, $\diamond$ from \cite{michieli2021sdr}. Other results come from re-implementation.}
