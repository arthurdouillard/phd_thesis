...
\begin{table}[t]
    ...
    \begin{adjustbox}{max width=\textwidth}
        ...
        \end{tabular}
    \end{adjustbox}
    \caption{\textbf{Description of the 12 different benchmarks} evaluated in this paper. For some of these, each task brings new classes while, for others, it comes with new domains.}
