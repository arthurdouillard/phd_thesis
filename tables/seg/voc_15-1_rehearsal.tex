\begin{table*}[t]
    ...
    \begin{adjustbox}{max width=\textwidth}
        ...
        \end{tabular}
    \end{adjustbox}
    \caption{\textbf{Pascal-VOC quantitative experiments with rehearsal} on Pascal-VOC 2012 15-1 overlap in \ac{mIoU} (\%). We only consider the time overhead spent after the first task whose computation overhead is similar for all methods.}
    \label{tab:seg_voc_rehearsal_learning}
\end{table*}
