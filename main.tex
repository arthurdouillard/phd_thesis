...
\newcommand{\ivs}{\textit{v.s.}}
\newcommand{\iie}{\textit{i.e.}}
...
\acresetall
\input{content/02_regularization.tex}
\cleardoublepage
\let\leftmark=\oldleftmark

\acresetall
\input{content/03_segmentation.tex}
\cleardoublepage
\let\leftmark=\oldleftmark

\acresetall
\input{content/04_dynamic.tex}
\cleardoublepage
\let\leftmark=\oldleftmark

\acresetall
\input{content/05_spacedrepetition.tex}
\cleardoublepage
\let\leftmark=\oldleftmark
