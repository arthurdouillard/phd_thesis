...
employed, the first model (PODNet) using Douillard et al.'s distillation \cite{douillard2020podnet}
constraining the statistics of the intermediate features after each residual block, and the second
...
axes, we reduce drastically forgetting, especially in challenging settings with a large quantity of
