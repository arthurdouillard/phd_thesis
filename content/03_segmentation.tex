...
In particular, in this paper, we argue that two problems arise when performing CSS with DCNNs. The
...
In the frame of classification, it is, to a certain extent, necessary to discard spatial information
...
\subsection{Pseudo-labeling to fix background shift}\label{sec:hardpl}
...
As second improvement we propose to exploit the cosine normalization for intermediary features: the
...
\begin{figure*}[ht!]
    \centering
    \includegraphics[width=1.0\linewidth]{images/seg/rehearsal_strategy.pdf}
...
All three improvements further increase performance for long series of tasks: (1) Cosine classifer
...
\subsubsection{Object Rehearsal}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{images/seg/dataset_viz.pdf}
    \vspace*{-0.3cm}
...
%We also include GIFS and SDR, two recent papers released after PLOP which also consider continual
...
\subsubsection{Longer Continual Learning}
...
\subsubsection{Robutness to class ordering}
...
\subsubsection{Rehearsal alternatives}
